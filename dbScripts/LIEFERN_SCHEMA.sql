...
CREATE TABLE `liefernUser` (
  ...
  UNIQUE KEY `createdDate_UNIQUE` (`createdDate`),
  UNIQUE KEY `modifiedDate_UNIQUE` (`modifiedDate`),
  KEY `fk_liefernRole_liefernUser_roleId_idx` (`liefernRoleId`),
  CONSTRAINT `fk_liefernRole_liefernUser_roleId` FOREIGN KEY (`liefernRoleId`) REFERENCES `liefernRole` (`roleId`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- -----------------------------------------------------
-- Table `liefern`.`liefernRole`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `liefern`.`liefernRole` ;

CREATE TABLE IF NOT EXISTS `liefern`.`liefernRole` (
...
CREATE TABLE `liefern`.`payments` (
  `paymentId` INT NOT NULL AUTO_INCREMENT,
  `userId` INT NULL,
  `creditCard` INT(12) NULL,
  `CVV` INT(3) NULL,
